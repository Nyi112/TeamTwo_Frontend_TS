...
import type { Building as BuildingType } from "../types/index.js";
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage all buildings within branches</p>
        </div>
        <button
          ...
          >
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <p className="flex items-center space-x-2">
                ...
                <span>{building.buildingCode || "N/A"}</span>
              </p>
              <p className="flex items-center space-x-2">
                <span className="font-medium">Floors:</span>
                <span>{building.totalFloors || "N/A"}</span>
              </p>
              <p className="flex items-center space-x-2">
                <span className="font-medium">Leasable Area:</span>
                <span>
                  {building.totalLeasableArea
                    ? `${building.totalLeasableArea} sqft`
                    : "N/A"}
                </span>
              </p>
